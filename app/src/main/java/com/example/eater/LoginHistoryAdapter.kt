...
class LoginHistoryAdapter(var logsVal:MutableList<LoginhistoryData>, var context: Context):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LoginHistoryAdapter.ViewHolder {
        ...
        val view=inflater.inflate(R.layout.loginhistorycontent,parent,false)
